...
<div class="form-container">
    ...
    <form action="/account?action=edit" method="post">
        ...
        <div class="mb-3">
            ...
            <input value="${sessionScope.user.phone}" name="description" required type="text" class="form-control" id="exampleInputPassword1">
        </div>
        <div class="mb-3">
            <label for="exampleInputPassword2" class="form-label">Trạng thái tài khoản</label>
            <input value="Đang hoạt động" readonly name="quantity" required type="text" class="form-control" id="exampleInputPassword2">
        </div>
